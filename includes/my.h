...
bool my_issort(const int *tab, size_t size);
...
//*! It's printing a meme.
void my_meme(int nbr);

//* It's filling the first n bytes of the memory area pointed to by s with c.
...
//* It's reallocating the memory of the pointer ptr.
